<%@ Page Title="" Language="C#" MasterPageFile="~/AdminModule/Admin.Master" AutoEventWireup="true" CodeBehind="ManageJobPost.aspx.cs" Inherits="JobPortal.AdminModule.ManageJobPost" %>
            ...
            <td>
                <asp:GridView ID="gvjobpostlist" runat="server" OnRowCommand="gvjobpostlist_RowCommand" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:Button ID="btndelete" Text="Delete" runat="server" CommandName="A" CommandArgument='<%#Eval("jpsid")%>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
